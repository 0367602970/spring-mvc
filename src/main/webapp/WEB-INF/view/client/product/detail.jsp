                    ...
                    <div class="col-lg-8 col-xl-9">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                ...
                                <form:form method="post" action="/add-product-from-view-detail" modelAttribute="product">
                                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                                    <input type="text" class="form-control d-none" value="${product.id}" name="id">
                                    <input type="text" class="form-control d-none" id="cartDetails0.quantity" name="quantity">
